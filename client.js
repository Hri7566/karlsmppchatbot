...
Client.prototype.connect = function() {
    var proxy2 = process.env.http_proxy || 'http://'   +this.proxy;
var opts = url.parse(proxy2);
var agent = new HttpsProxyAgent(opts);
    ...
    if(typeof module !== "undefined") {
        // nodejsicle
        if(typeof this.proxy!='null'&&typeof this.proxy!='undefined'){
        this.ws = new WebSocket(this.uri, {
            origin: "www.multiplayerpiano.com",
            agent: agent
        });
        }else{this.ws = new WebSocket(this.uri, {
            origin: "www.multiplayerpiano.com"
